...
static inline unsigned int sys_clock_hw_cycles_per_sec_runtime_get(void)
{
	...
	if (z_syscall_trap()) {
		return (unsigned int) arch_syscall_invoke0(K_SYSCALL_SYS_CLOCK_HW_CYCLES_PER_SEC_RUNTIME_GET);
	}
#endif
	compiler_barrier();
